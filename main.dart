void main() {
  ...
  double altura = 1.86;
  bool geek = true;
  const String nome = 'Patrick Alvares';
  ...
  List<dynamic> patrick = [idade, altura, geek, nome, apelido];

  //Frase que recebe os dados diretamente da Lista
  String frase = 'Eu sou ${patrick[4]} \n'
      'mas meu nome completo é: ${patrick[3]}, \n'
      'eu me considero geek? ${patrick[2]}. \n'
      'Eu tenho ${patrick[1]} metros de altura e \n'
      '${patrick[0]} anos de idade,\n'
